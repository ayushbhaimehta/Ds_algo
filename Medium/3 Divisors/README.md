<h2><a href="https://practice.geeksforgeeks.org/problems/3-divisors3942/1?page=6&difficulty[]=1&difficulty[]=2&status[]=unsolved&sortBy=submissions">3 Divisors</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p>You are given a list&nbsp;of q queries and for every query, you are given an integer N.&nbsp; The task is to find how many numbers(<strong>less than or equal to N)&nbsp;</strong>have number&nbsp;of divisors exactly equal to <strong>3</strong>.</p>
