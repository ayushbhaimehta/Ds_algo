<h2><a href="https://practice.geeksforgeeks.org/problems/matrix-exponentiation2711/1?page=17&difficulty[]=1&difficulty[]=2&status[]=unsolved&sortBy=submissions">Matrix Exponentiation</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an equation of the form f(n) = f(n-1) + f(n-2) where f(0) = 1, f(1) = 1&nbsp;, the task is to find the n<sup>th</sup>&nbsp;term of this sequence.</span><br>
&nbsp;</p>
